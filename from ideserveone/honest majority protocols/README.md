...
- **《Unconditional Communication-Efficient MPC via Hall’s Marriage Theorem》**, CRYPTO 2021  
  ...
  技术是通过 **Packed Secret Sharing (PSS)** 批量计算一层乘法门，并利用图论中的 **Hall’s Marriage Theorem** 完成数据对齐。  
